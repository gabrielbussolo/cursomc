...
//service que antes estava na classe main, agora é um service. (mais organizado)
@Service
public class DBService {
	...
	public void instanciateTestDatabase() throws Exception {
		...
		Produto p4 = new Produto(null, "Toalha", 300.);
		Produto p5 = new Produto(null, "Colcha", 300.);
		Produto p6 = new Produto(null, "TV true color", 300.);
		Produto p7 = new Produto(null, "Roçadeira", 300.);
		Produto p8 = new Produto(null, "Abajour", 300.);
		Produto p9 = new Produto(null, "Pendente", 300.);
		Produto p10 = new Produto(null, "Shampoo", 300.);
		Produto p11 = new Produto(null, "Mesa de escritorio", 300.);
		...
		// troquei o email da maria para o meu, pra testar somente no ambiente de test e
		// dev
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123")); //passa senha encodada
		cli1.getTelefones().addAll(Arrays.asList("27363323", "96838393"));
		
		Cliente cli2 = new Cliente(null, "Gabriel Ferreira", "gabreeiel@gmail.com", "83125407095", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("9139940267", "91981290590"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Padre Júlio Maria", "473", "Apt 123", "Cruzeiro (Icoaraci)", "66810060", cli2, c2);
		
		cli1.getEnderecos().addAll(Arrays.asList(e1, e2));
		cli2.getEnderecos().addAll(Arrays.asList(e3));
		//adicionando novo cliente com perfil de adm, cli2
