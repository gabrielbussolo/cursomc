...
public abstract class Pagamento implements Serializable{
	...
	@Id
	private Integer id;
	private Integer estado; //enum com sistema igual ao enum do tipocliente no cliente
	
	//relacionamento um para um, sendo que pagamento tem pedido id como id, por isso nao tem generated value
	@OneToOne
